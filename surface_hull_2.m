function Surface=surface_hull_2(x)  
%====================================================================== 
% This function calculates the wetted surface of the hull of an AUV.
...
% La=3.6D. It uses a numerical approximation (Discretization with  % n=1000) 
%======================================================================   
